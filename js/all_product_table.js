...
$('.add-product-description').on('click', function(){
    $.ajax({
        type: "POST",
        url: baseURL+"/add/description/action",
...
$('.add-color-brand').on('click', function(){
    $.ajax({
        type: "POST",
        url: baseURL+"/add/gmts/color/action",
