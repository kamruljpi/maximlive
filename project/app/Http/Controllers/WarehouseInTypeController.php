...
class WarehouseInTypeController extends Controller
{
    const CREATE 		= 'create' ;
	const UPDATE 		= 'update' ;
	...
	public function index(){
        ...
        $warehouse_type_list = MxpWarehouseType::where('warehouse_in_out_type','in')->paginate(10);
        return view('warehouse_type.warehouse_in_type_list', compact('warehouse_type_list'));
    }
    public function createview(){
    	return view('warehouse_type.warehouse_in_type_create');
    }
	public function store(Request $request){
        ...
        return Redirect()->Route('warehouseintypelist');
	}
    public function updateView(Request $request)
    {
        ...
        return view('warehouse_type.warehouse_in_type_edit', compact('warehousetype'));
    }
