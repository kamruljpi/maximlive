...
class CreateMxpProductionRawItemWasteTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mxp_production_raw_item_waste', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mxp_production_raw_item_waste');
    }
}
