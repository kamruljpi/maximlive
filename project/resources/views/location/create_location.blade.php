...
@section('page_heading','Create Location')
@section('section')
	        ...
	        <div class="col-md-12 col-sm-12">
	            ...
	            <div class="panel panel-default">
	                ...
	                <div class="panel-body">
	                    <form class="form-horizontal" action="{{ Route('location_save_action') }}" role="form" method="POST" >
	                            ...
	                            <div style="" class="col-md-12 col-sm-12 ">
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-md-6 col-sm-6">
	                                        <input type="text" class="form-control input_required" name="location" value="{{ old('location') }}" placeholder="Location">
	                                    </div>
	                                </div>                      
