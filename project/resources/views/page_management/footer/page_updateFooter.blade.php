...
@section('page_heading',trans('others.update_page_footer_title_label'))
@section('section')
		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="{{route('updatefooter_action')}}/{{$title->footer_id}}">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control input_required" name="footer_title" value="{{$title->title}}">
							</div>
						</div>
