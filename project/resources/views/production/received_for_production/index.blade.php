...
@section('page_heading','Received for Production')
@section('section')
    <style type="text/css">
    	.top-btn-pro{
    		padding-bottom: 15px;
    ...
    <div class="col-sm-3 top-btn-pro">
        {{-- <a href="{{ Route('received_for_production_create_view') }}" class="btn btn-success form-control" style="font-weight: bold;">
        New Reveived Production</a> --}}
    </div>
