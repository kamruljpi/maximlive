				...
				<div class="panel panel-default custom">
					...
					<form action="{{ Route('purchase_order_store_action')}}" method="POST">
						...
						<div class="panel-body">
							<div class="col-sm-10">
								<div class="form-group">
									<label class="col-sm-4 date-label"><span>Date</span></label>
									<div class="col-sm-6">
								...
								<div class="form-group">
									<label class="col-sm-4 date-label"><span>Purchase Order No</span></label>
									<div class="col-sm-6">
								...
								<div class="form-group">
									<label class="col-sm-4 date-label"><span>Description</span></label>
									<div class="col-sm-6">
