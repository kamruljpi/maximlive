...
@section('page_heading','Update Raw Item')
@section('section')
	<style type="text/css">
			...
			<div class="col-md-12 col-md-offset-0">
				...
				<div class="panel panel-default custom">
					...
					<div class="panel-body">
						<form action="{{ Route('raw_item_edit_action')}}/{{ $details->id_raw_item}}" method="POST">
							...
							<div class="col-sm-8 col-md-offset-2">
								<div class="form-group">
									...
									<div class="col-sm-12">
										<input type="text" name="item_name" class="form-control" placeholder="Item Name" value="{{$details->item_name}}">
									</div>
								</div>
							</div>
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<div class="col-sm-12" style="padding: 0 !important">
											<input type="text" name="item_code" class="form-control input_required" placeholder="Item Code" value="{{$details->item_code}}">
										</div>
									</div>								
									...
									<div class="form-group">
										...
										<div class="col-sm-12" style="padding: 0 !important">
											<input type="text" name="price" class="form-control" placeholder="Price" value="{{$details->price}}">
										</div>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										...
										<div class="col-sm-12">
											<input type="text" name="opening_qty" class="form-control" placeholder="Opening Quantity" value="{{$details->opening_quantity}}" style="width: 85% !important">
										</div>
									</div>
							...
							<div class="col-sm-8 col-md-offset-2">
								<div class="form-group">
									...
									<div class="col-sm-11">
										<textarea name="sort_description" class="form-control" placeholder="Write here...">	{{trim($details->sort_description)}}		
										</textarea>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-2 col-sm-offset-7" style="padding-top: 10px !important">
								<div class="form-group">
									<button class="form-control btn btn-primary">Update Item</button>
								</div>
							</div>
						</form>
					</div>
