            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body showTask">
                    ...
                    <form class="form-horizontal inputForm" role="form" method="POST" action="{{ Route('task_action') }}">
                            ...
                            <input type="hidden" name="mrfIdList" id="hiddenMrfIdList" disabled="true">
                            ...
                            <div class="form-group mrfId hidden">
                                <label class="col-md-4 control-label">
                                    <span class="pull-right">Mrf No.</span>
                                </label>
                                <div class="col-md-6">
                                    <input type="text" name="mrfId" class="form-control mrfId" disabled="true" id="mrfId" placeholder="Mrf No">

                                    <div id="mrfIdList"></div>
                                </div>
                            </div>
...
@endsection
@section('LoadScript')
    <script src="{{ asset('assets/scripts/task/mrf_auto_search.js') }}"></script>
@endsection
