...
@section('page_heading','WareHouse In Type Create')
@section('section')
        ...
        <div class="col-md-12 col-sm-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{{ Route('warehouseintypestore') }}" role="form" method="POST" >
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="row">
                            <div style="" class="col-md-12 col-sm-12 ">
                                <div class="form-group">
                                    <div class="col-md-6 col-sm-6">
                                        <input type="hidden" class="form-control" name="warehouse_in_out_type" value="in">
                                    </div>
                                </div>
                                <div class="form-group">
