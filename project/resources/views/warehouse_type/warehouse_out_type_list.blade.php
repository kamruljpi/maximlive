...
@section('page_heading', 'Warehouse Out Type List')
@section('section')
<style type="text/css">
	.top-btn-pro{
		padding-bottom: 15px;
...
<div class="col-sm-3 top-btn-pro">
	<a href="{{ Route('warehouseouttype') }}" class="btn btn-success form-control">
    Add Warehouse Out Type</a>
</div>
    ...
    <div class="table-responsive">
        ...
        @foreach($warehouse_type_list as $warehouseList)
            <tr>  
                ...
                <td>
                    <a href="{{ Route('warehouseouttypeupdateView')}}/{{$warehouseList->id_warehouse_type}}" class="btn btn-success">edit</a>
                    <a href="{{ Route('warehouseouttypedelete')}}/{{$warehouseList->id_warehouse_type}}" class="btn btn-danger">delete</a>
                </td>
            </tr>
        @endforeach 
