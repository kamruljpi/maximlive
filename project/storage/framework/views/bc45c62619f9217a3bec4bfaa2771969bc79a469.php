...
<head>
	...
	<link rel="shortcut icon" href="<?php echo e(asset('assets/img/icon.png')); ?>" type="image/x-icon" />
...
<body>
	...
	<script src="<?php echo e(asset('assets/scripts/item/apend_unit_price.js')); ?>"></script>
	...
	<script src="<?php echo e(asset('assets/scripts/booking/booking_view/view_page.js')); ?>"></script>
	<script src="<?php echo e(asset('assets/scripts/confirm/confirmation.js')); ?>"></script>
